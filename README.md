...
2. Summary
* Data: 2.5+ million borrowers with ~150 features (2.2+ GB)
* Objective: Predict the probability of charge-off for each borrower and calculate the potential loan loss
